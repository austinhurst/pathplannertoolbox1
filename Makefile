...
$(OBJDIR)/main.o : $(SRCDIR)/main.cpp $(HDIR)/mapper.h $(HDIR)/randGen.h $(HDIR)/fileReader.h $(HDIR)/simpleRRT.h
	$(CC) $(CXXFLAGS) -o$(OBJDIR)/main.o $(SRCDIR)/main.cpp

$(OBJDIR)/mapper.o : $(SRCDIR)/mapper.cpp $(HDIR)/mapper.h $(HDIR)/map_s.h $(HDIR)/randGen.h
...
$(OBJDIR)/simpleRRT.o : $(SRCDIR)/simpleRRT.cpp $(HDIR)/simpleRRT.h $(HDIR)/map_s.h $(HDIR)/pathPlanner.h
